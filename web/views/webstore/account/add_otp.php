...
<div class="profile-container">
    ...
    <div style="display: flex; flex-flow: column; gap: 1rem;">
        <div>
            Current 2FA status: <b><?= $user->totpSecret !== null ? 'Enrolled' : 'Unenrolled' ?></b>
        </div>

        <?php if ($user->totpSecret === null): ?>
            <div>
                ...
                <form id="register-2fa">
                    ...
                    <input type="text" name="code" id="code" style="width: auto">
        ...
        <?php else: ?>
            <div>
                <h2>Unregister 2FA Authenticator</h2>

                <p>This account is already setup with a Two-Factor Authentication code.</p>

                <p>To remove the 2FA, please enter the code generated on your authenticator app.</p>

                <form id="unregister-2fa" style="display: flex; gap: 0.5rem; align-items: center; margin-top: 1rem;">
                    <label for="code" style="margin: 0">Code</label>
                    <input id="code" type="text" name="code" style="width: auto">
                    <span class="validity">The code is incorrect.</span>
...
<script>
    ...
    $("form#unregister-2fa").submit(/** @param {jQuery.Event} e */ function (e) {
        e.preventDefault();
