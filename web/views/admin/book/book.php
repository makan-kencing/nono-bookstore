...
?>
    ...
    <link rel="stylesheet" href="/static/styles/admin/book.css">
                ...
                <div class="book-details">
                            ...
                            <div class="carousel">
                                <div class="carousel-images">
                                    <?php foreach ($book->images as $image) : ?>
                                        <div class="image-container" style="order: <?= $image->imageOrder ?>; ">
                                            <div>
                                                <img src="<?= $image->file->filepath ?>" alt="<?= $image->file->alt ?>">
                                            </div>
                                            <form id="remove-image" action="/api/book/<?= $book->id ?>/image/<?= $image->file->id ?>">
                    ...
                    <div>
                        <div>
                            ...
                            <form action="/api/book/<?= $book->id ?>/author" id="add-author">
                        ...
                        <div>
                            ...
                            <form action="/api/book/<?= $book->id ?>/price" id="add-price">
                        ...
                        <div>
                            ...
                            <form action="/api/book/<?= $book->id ?>/cost" id="add-cost">
